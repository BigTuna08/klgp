...
pub trait EA{
    fn run(&mut self);
    fn new(args: &HashMap<String,String>) -> Self;
    fn cv(&self);
    // fn new<T: EA>(args: &HashMap<String,String>) -> T{
    //
    // }
}
...
impl EA for BasicEA{
    fn run(&mut self) {
        let n_evals = 1_000_000; // 1 mill
        let cv_interval = 10_000;
    ...
    fn new(args: &HashMap<String,String>) -> BasicEA{
...
pub trait Population{
    fn new(args: &HashMap<String,String>, devel_env: &DevelEnv, eval_env: &EvalEnv) -> Self;
...
impl Population for BasicPop{
    ...
    fn new(args: &HashMap<String,String>, devel_env: &DevelEnv, eval_env: &EvalEnv) -> BasicPop{
...
pub fn extract_val<T: std::str::FromStr + std::fmt::Debug>(val: &str, args: &HashMap<String,String>) -> T{
